        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-3 py-3 text-sm"><?php $sc=['open'=>'bg-blue-100','acknowledged'=>'bg-indigo-100','in_progress'=>'bg-yellow-100','waiting_parts'=>'bg-orange-100','waiting_approval'=>'bg-purple-100','resolved'=>'bg-green-100','closed'=>'bg-gray-100','cancelled'=>'bg-red-100','rejected'=>'bg-rose-100']; ?><span class="inline-flex px-2 py-0.5 text-xs font-semibold rounded-full <?= $sc[$r['status']]??'bg-gray-100' ?>"><?= htmlspecialchars($statusOptions[$r['status']]??$r['status']) ?></span></td>
                    <td class="px-3 py-3 text-sm"><?php $pm=['low'=>'bg-gray-100','medium'=>'bg-blue-100','high'=>'bg-orange-100','critical'=>'bg-red-100']; ?><span class="inline-flex px-2 py-0.5 text-xs font-semibold rounded-full <?= $pm[$r['priority']]??'bg-gray-100' ?>"><?= htmlspecialchars($r['priority']) ?></span></td>
