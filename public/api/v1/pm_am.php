...
try {
    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            $allowed = ['asset_id', 'assigned_to', 'title', 'description', 'frequency_type', 'frequency_interval', 'due_date', 'last_done_date', 'status', 'checklist', 'notes', 'plan_id', 'department_id', 'location_id', 'work_zone_id', 'work_instruction_file', 'completed_at', 'completed_by', 'reschedule_reason', 'reschedule_to', 'deferral_status', 'deferral_requested_by', 'deferral_requested_at', 'inspector_signature', 'operator_signature', 'operator_name', 'reviewer_signature', 'signed_at', 'is_outsource', 'outsource_by', 'cost_outsource'];
            $cols = []; $vals = [];
