...
try {
    ...
    switch ($method) {
        case 'GET':
            ...
            $keys = ['line_notify_enabled','line_notify_token','line_channel_access_token','line_channel_secret','line_channel_id','line_liff_id','line_callback_url','line_maintenance_group_id','low_stock_alert','maintenance_alert_days','email_notify_enabled','telegram_enabled','telegram_bot_token','telegram_chat_id','line_system_alerts','line_weekly_report'];
            $settings = [];
