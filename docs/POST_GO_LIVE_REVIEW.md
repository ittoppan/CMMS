...
## 6. เพิ่มเติมจาก Phase 22 (2026-09-17) — กลไก monitoring/feedback พร้อมใช้แล้ว
- **§3 เริ่มตรงช่องจริง**: ผู้ใช้ในระบบกรอกได้เองที่ `/feedback` (สิทธิตามบทบาท; admin ปรับสถานะ) — รายละเอียดใน `docs/USER_FEEDBACK.md`
- **§4/§5 ระบุตัวเลขได้จริง**: `docs/PRODUCTION_MONITORING.md` (health dashboard + system_errors กลาง) และ `docs/PRODUCTION_DATA_QUALITY.md` (รายการข้อบกพร่องจริงประจำวัน)
- **รายการที่ต้องแก้ก่อน pilot** (เพิ่มจาก Phase 21): ดู `docs/IMPROVEMENT_BACKLOG.md` — P0 ยังค้าง: I-01 TLS, I-02 บัญชีจริง, I-08 LINE quota
- **Threshold ที่จะตรวจใน review 30 วัน**: ใช้ตารางใน §1 ข้างบน + ค่า baseline ที่บันทึกใน `docs/PERFORMANCE_MONITORING.md`
- หมายเหตุความถูกต้อง: ระบบยังไม่ถูกใช้งานจริง — เอกสารนี้ยังเป็นแม่แบบประเมิน ตัวเลขจริงจะลงเมื่อ pilot จบ
