...
return [
    ...
    ['key' => 'calibration/instruments',    'href' => '/calibration/instruments',   'label' => 'α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕íα╕╖α╕¡α╕ºα╕▒α╕ö (Instrument Master)', 'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/plans',          'href' => '/calibration/plans',         'label' => 'α╣üα╕£α╕Öα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',          'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/schedule',       'href' => '/calibration/schedule',      'label' => 'α╕òα╕▓α╕úα╕▓α╕çα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',         'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/dashboard',      'href' => '/calibration/dashboard',     'label' => 'α╣üα╕öα╕èα╕Üα╕¡α╕úα╣îα╕öα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',      'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/standards',      'href' => '/calibration/standards',     'label' => 'α╕íα╕▓α╕òα╕úα╕Éα╕▓α╕Öα╕¡α╣ëα╕▓α╕çα╕¡α╕┤α╕ç',        'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/procedures',     'href' => '/calibration/procedures',    'label' => 'α╕éα╕▒α╣ëα╕Öα╕òα╕¡α╕Öα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',       'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/certificates',   'href' => '/calibration/certificates',  'label' => 'α╣âα╕Üα╕úα╕▒α╕Üα╕úα╕¡α╕çα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',      'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/oot',            'href' => '/calibration/oot',           'label' => 'OOT / α╕Öα╕¡α╕üα╣Çα╕üα╕ôα╕æα╣î',       'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/reports',        'href' => '/calibration/reports',       'label' => 'α╕úα╕▓α╕óα╕çα╕▓α╕Öα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',        'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/data-quality',   'href' => '/calibration/data-quality',  'label' => 'α╕äα╕╕α╕ôα╕áα╕▓α╕₧α╕éα╣ëα╕¡α╕íα╕╣α╕Ñα╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',  'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/mobile',         'href' => '/calibration/mobile',        'label' => 'α╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Üα╕Üα╕Öα╕íα╕╖α╕¡α╕ûα╕╖α╕¡',      'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
    ['key' => 'calibration/config',         'href' => '/calibration/config',        'label' => 'α╕òα╕▒α╣ëα╕çα╕äα╣êα╕▓α╕¬α╕¡α╕Üα╣Çα╕ùα╕╡α╕óα╕Ü',       'section' => 'PM & α╣Çα╕äα╕úα╕╖α╣êα╕¡α╕çα╕êα╕▒α╕üα╕ú'],
