...
export const NAV_GROUPS: NavGroupDef[] = [
  {
    ...
    items: [
      ...
      { perm: "field", labelKey: "menu.field_work", href: "/field", icon: ScanLine },
  ...
  },
  {
    ...
    pathPrefixes: ["/pm_am", "/inspections", "/asset_registry", "/assets", "/qr-sheet", "/equipment_borrowing", "/calibration", "/mtbf_mttr", "/asset-reliability"],
    items: [
      ...
      { perm: "asset_reliability", labelKey: "menu.asset_reliability", href: "/asset-reliability", icon: Gauge },
      { perm: "asset_reliability/critical", labelKey: "menu.asset_reliability_critical", href: "/asset-reliability/critical", icon: Flame },
      { perm: "asset_reliability/lifecycle", labelKey: "menu.asset_reliability_lifecycle", href: "/asset-reliability/lifecycle", icon: CircleDot },
      { perm: "asset_reliability/aging", labelKey: "menu.asset_reliability_aging", href: "/asset-reliability/aging", icon: Hourglass },
      { perm: "asset_reliability/replacement", labelKey: "menu.asset_reliability_replacement", href: "/asset-reliability/replacement", icon: Boxes },
      { perm: "asset_reliability/overhaul", labelKey: "menu.asset_reliability_overhaul", href: "/asset-reliability/overhaul", icon: Hammer },
      { perm: "asset_reliability/data-quality", labelKey: "menu.asset_reliability_data_quality", href: "/asset-reliability/data-quality", icon: BadgeCheck },
      { perm: "asset_reliability/reports", labelKey: "menu.asset_reliability_reports", href: "/asset-reliability/reports", icon: BarChart3 },
      { perm: "asset_reliability/config", labelKey: "menu.asset_reliability_config", href: "/asset-reliability/config", icon: Settings },
    ],
  },
  {
